...
> <img src="图片文件\Spring\导入Spring框架.png"  />

#### 2.编写Dao接口和实现类

> ![](图片文件\Spring\编写Dao接口.png)
>
> ![](图片文件\Spring\编写Dao实现类.png)

#### 3.创建Spring核心配置文件

> ![](图片文件\Spring\创建Spring核心配置文件.png)

#### 4.创建Spring配置文件中配置UserDaoImpI

> ![](图片文件\Spring\创建Spring配置文件中配置UserDaoImpI.png)

#### 5.使用Spring的API获得Bean实例

> ![](图片文件\Spring\使用Spring的API获得Bean实例.png)
